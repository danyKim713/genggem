...
<script script src="https://apis.openapi.sk.com/tmap/js?version=1&format=javascript&appKey=l7xxe5689f02a1d245968de20745010d1af1"></script>
<script>		
// map 생성
...
var headers = {}; 
headers["appKey"]="l7xxe5689f02a1d245968de20745010d1af1";//실행을 위한 키 입니다. 발급받으신 AppKey(appKey)를 입력하세요.
$.ajax({
	method:"POST",
	headers : headers,
