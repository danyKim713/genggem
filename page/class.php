...
<!-- ##### img Area Start ##### -->
    <div class="breadcrumb-area3">
        <!-- Top Breadcrumb Area -->
        <div class="top-breadcrumb-area bg-img d-flex align-items-center justify-content-center" style="background-image: url(./assets/img/bg-img/sub_bg120.jpg);">
        </div>
    </div>
    <!-- img Area End -->
					...
					<div class="single-footer-widget">
						<div class="social-info">
							<? 
									...
									echo "<a href=\"class_list.php?txtBCat={$rowNavCat["cat_id"]}\">{$rowNavCat["cat_nm"]}</a>";
									} 
								?>
					...
					<div class="single-widget-area">
						...
						<div class="single-latest-post d-flex align-items-center">
							...
							<div class="post-content">
								...
								<div style="margin-top:5px;"><a href="class_payment.php?txtRecordNo=<?=$rowPopLesson["l_id"]?>"  class="btn-o3 mt-2 ellipsis"><li class="fas fa-check"></li> 강좌신청</a>
					...
					<div class="col-12 col-sm-6 col-lg-4">
						<div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="100ms">
							...
							<div class="product-info mt-15">
								...
								<a href="class_payment.php?txtRecordNo=<?=$rowLesson["l_id"]?>"  class="btn-o2 mt-2 mr-1"><li class="fas fa-check"></li> 강좌신청</a>
					...
					<div class="col-12 col-sm-6 col-lg-4">
						<div class="single-product-area mb-50 wow fadeInUp" data-wow-delay="100ms">
							...
							<div class="product-info mt-15">
								...
								<a href="class_payment.php?txtRecordNo=<?=$rowRecommLesson["l_id"]?>"  class="btn-o2 mt-2 mr-1"><li class="fas fa-check"></li> 강좌신청</a>
