...
$query = "select COUNT(review_id) AS cnt from tbl_store_review where member_id = '{$ck_login_member_pk}'";
...
$query = "select * from tbl_store_review where member_id = '{$ck_login_member_pk}' order by review_id DESC {$limit} ";
