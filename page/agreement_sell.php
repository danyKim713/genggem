...
<? include "./inc_nav.php"; ?>
		...
		<div>
			<ul>
				...
				<li class="wow fadeInDown">
					...
					<a href="agreement_sell.php" title='셀러약관'>
						<div><i class="fas fa-edit" aria-hidden="true"></i></div>
						<p class="txt_tit">셀러약관</p>
					</a>
				</li>
				<li class="wow fadeInUp">
					<a href="contact.php">
	...
	<tr>
		...
		Cafehands(이하 ‘회사’라 함)는 고객님의 정보를 중요하게 생각하며 아래와 같은 개인정보처리방침을 가지고 있습니다. 회사는 “정보통신망 이용촉진 및 정보보호 등에 관한 법률”을 준수하며 고객님의 정보가 어떤 용도와 방식으로 사용되고 있으며 개인정보보호를 위해 어떤 조치를 취하고 있는지 알려드립니다.<br><br>
		...
		4. 개인정보 제공 및 공유<br>
		회사는 회사 회원에게 보다 나은 서비스를 제공하기 위해 Cafehands(Cafehands.com), Cafehands쇼핑몰(Cafehands.com/shop), Cafehands App. 및 가맹점과 회원 정보를 공유합니다. 공유하는 정보의 내용은 개인식별정보(성명, 연락처, 이메일주소) 등이며, 서비스 제공 및 마케팅 목적 이외의 다른 목적으로 정보를 공유하지 않습니다.<br>
		...
		개인정보관리 책임자 배용식<br>
		E-mail: cafehands99@gmail.com<br>
		...
		E-mail: cafehands99@gmail.com<br><br>
