...
$query = "select * from gf_chatting_history where fk_channel = '{$rowChannel['pk_channel']}' and pk_chatting_history > {$pk_chatting_history} order by 채팅일시 DESC LIMIT 0,1";
//echo $query;
...
?>
								...
								<div class="received-box talk-box d-flex">
