...
$strBaseArea         = trim($_POST['selBaseArea']);  // 아티스트기본지역
$strLessonGreetings  = trim($_POST['txtLessonGreetings']);  // 레슨인사말
$strBankNM           = trim($_POST['txtBankNM']);  // 은행명
$strBankAccount      = trim($_POST['txtBankAccount']);  // 계좌번호
$strBankAccountHolder = trim($_POST['txtBankAccountHolder']);  // 예금주명
...
if($cnt > 0) {
    ...
    $query .= "        아티스트기본지역        = '{$strBaseArea}',  ";
    $query .= "        은행명               = '{$strBankNM}',  ";
    $query .= "        계좌번호              = '{$strBankAccount}',  ";
    $query .= "        예금주명              = '{$strBankAccountHolder}'  ";
